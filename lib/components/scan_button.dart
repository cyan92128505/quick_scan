...
import 'package:quick_scan/services/vibrate_service.dart';
...
class _ScanButtonState extends State<ScanButton> {
  ...
  void ready(BuildContext context) async {
    try {
      channelService.eventChannel.receiveBroadcastStream().listen(
        (
          dynamic event,
        ) {
    ...
    try {
      final String result = await channelService.methodChannel
          .invokeMethod(EventSet.READY_INVOKE);
